...
//    public static void extract(Iterable<? extends Symbol> symbols, Set<Symbol> querySymbols, Collection<Symbol> result){
//        Context ctx = new Context(querySymbols, result);
